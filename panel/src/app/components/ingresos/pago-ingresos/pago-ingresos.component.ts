...
@Component({
  selector: 'app-pago-ingresos',
  templateUrl: './pago-ingresos.component.html',
  styleUrls: ['./pago-ingresos.component.css']
})
export class PagoIngresosComponent implements OnInit {
    ...
    ngOnInit(): void {
      this._route.params.subscribe(
        params=>{
          this.id = params['id'];       
          this._ingresoService.obtener_ingreso_admin(this.id,this.token).subscribe(
            response=>{
    ...
    pagos_ventas(){
      ...
      this._pagoService.obtener_pago_ig_admin(this.id,this.token).subscribe(
        response=>{
    ...
    generar_pago_ingreso(){
      this.pago.cliente = this.ingreso.proyecto._id;
      ...
      if (!this.pago.metodo) {
        ...
        this._pagoService.crear_pagovingreso_admin(this.pago,this.token).subscribe(
          response=>{
